...
App.CurrencyButton.prototype = Object.create(App.SwipeButton.prototype);
 ...
 * @param {string} mode
 */
App.CurrencyButton.prototype.setModel = function getModel(model,mode)
{
    this._model = model;
    this._mode = mode;
 ...
 * @returns {Account}
 */
App.CurrencyButton.prototype.getModel = function getModel()
{
    return this._model;
};
 ...
 * @returns {number}
 */
App.CurrencyButton.prototype.getClickMode = function getClickMode(data)
{
 ...
 * @private
 */
App.CurrencyButton.prototype._updateSwipePosition = function _updateSwipePosition(position)
{
 ...
 * @private
 */
App.CurrencyButton.prototype._getSwipePosition = function _getSwipePosition()
{
